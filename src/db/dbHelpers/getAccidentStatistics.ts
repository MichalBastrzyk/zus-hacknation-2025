...
import { accidents, ACCIDENT_TYPES, ACCIDENT_SEVERITIES, REPORT_STATUSES } from "../schema"
...
const DEFAULT_ACCIDENTS = [
    { type: ACCIDENT_TYPES[1], severity: ACCIDENT_SEVERITIES[2], status: REPORT_STATUSES[1] },
    { type: ACCIDENT_TYPES[2], severity: ACCIDENT_SEVERITIES[1], status: REPORT_STATUSES[2] },
    { type: ACCIDENT_TYPES[0], severity: ACCIDENT_SEVERITIES[2], status: REPORT_STATUSES[2] },
    { type: ACCIDENT_TYPES[1], severity: ACCIDENT_SEVERITIES[0], status: REPORT_STATUSES[1] },
    { type: ACCIDENT_TYPES[2], severity: ACCIDENT_SEVERITIES[1], status: REPORT_STATUSES[3] },
    { type: ACCIDENT_TYPES[0], severity: ACCIDENT_SEVERITIES[0], status: REPORT_STATUSES[2] },
]
...
export async function getAccidentSeverityStatistics(): Promise<StatisticData[]> {
    try {
